...
import com.example.asif.cuny.CheckBoxAdapter.CheckableRelativeLayout;
...
public class BrowseResourceActivity extends ActionBarActivity {
   ...
   /* public void firstTimefunc(){
    ...
    public class ListCustomAdapter extends ArrayAdapter<String> {
        ...
        ArrayList<String> listResType1 = new ArrayList<>();
        int i = 0;
        int count=-1;
            ...
            try {
                ...
                if (id1 != null) {
                    ...
                    try {
                        ...
                        if (intent.getStringExtra("InstalledIDs") != null) {
                            listResType1.add(dataBaseHelper.getBuildingResourceType(list_text.getText().toString()));
                            listResType = listResType1;
                        } else {
                ...
                if (filterList.size() > 0) {
                    ...
                    getdata(listResType, count, image_icon);
                }else
