...
public class BAL {
    ...
    public boolean UpdatePosition(PositionList been){
        try{
            ...
            contentValues.put("_ID",been.getId());
            contentValues.put("Position", been.getPosition());
            sqLiteDatabase.update(DBConnect.TABLE_NAME5, contentValues, "ListTitle = ?", new String[]{been.getListTitle()});
            sqLiteDatabase.close();
            return true;
        }catch (Exception e){
            e.printStackTrace();
    ...
    public List<Integer> getPosition(String buildname){
        ...
        try{
            SQLiteDatabase sqLiteDatabase = db.getWritableDatabase();
            String query = "SELECT PositionList.ListTitle, PositionList.Position,DCASBuilding.DCASBuildingName" +
...
/*
    ...
    {
        SQLiteDatabase sqLiteDatabase = db.getWritableDatabase();
        return sqLiteDatabase.delete(DBConnect.TABLE_NAME5,"_ID = ?",new String[]{id});
